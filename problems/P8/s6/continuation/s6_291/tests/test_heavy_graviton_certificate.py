...
import pytest
from p8_vacuum_affine_heavy_graviton_production_threshold import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_complete_production",
    "whole_dimensional_cut_and_threshold_Laurent_remainder",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_dimensional_cut_and_threshold_Laurent_remainder"]
    else:
