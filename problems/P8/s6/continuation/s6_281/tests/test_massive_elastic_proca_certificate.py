...
import pytest
from p8_vacuum_affine_massive_elastic_proca_infrared import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_elastic_tree",
    "whole_finite_soft_Proca_and_species_cut",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_finite_soft_Proca_and_species_cut"]
    else:
