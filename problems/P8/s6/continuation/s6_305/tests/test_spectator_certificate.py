...
import pytest
from p8_vacuum_affine_spectator_gravity_insertion import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_spectator_insertions",
    "whole_known_matching_and_uniform_rate",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_known_matching_and_uniform_rate"]
    else:
