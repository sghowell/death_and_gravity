...
import pytest
from p8_vacuum_affine_one_newton_inclusive_assembly import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_actual_finite_kappa_source_and_complete_matter_loop",
    "whole_positive_Born_forward_boundary_and_inclusive_assembly",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_positive_Born_forward_boundary_and_inclusive_assembly"]
    else:
