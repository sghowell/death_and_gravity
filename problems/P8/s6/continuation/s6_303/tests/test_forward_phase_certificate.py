...
import pytest
from p8_vacuum_affine_finite_forward_phase import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_finite_forward_phase",
    "whole_regularized_forward_bound_and_real_rate",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_regularized_forward_bound_and_real_rate"]
    else:
