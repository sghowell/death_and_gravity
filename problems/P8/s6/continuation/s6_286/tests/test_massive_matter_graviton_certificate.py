...
import pytest
from p8_vacuum_affine_massive_matter_graviton_vertex import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_conditional_Ward",
    "whole_massive_matter_F1_and_t_channel_matching",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_massive_matter_F1_and_t_channel_matching"]
    else:
