...
import pytest
from p8_vacuum_affine_heavy_resonance_soft_pole_pairing import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_complete_minimal_transition",
    "whole_normal_sheet_masters_and_finite_formal_pairing",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_normal_sheet_masters_and_finite_formal_pairing"]
    else:
