...
import pytest
from p8_vacuum_affine_ordinary_gravity_ward_bridge import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_gauge_bridge",
    "whole_continuity_and_raw_charge_normalization",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_continuity_and_raw_charge_normalization"]
    else:
