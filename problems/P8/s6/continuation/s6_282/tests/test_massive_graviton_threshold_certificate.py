...
import pytest
from p8_vacuum_affine_massive_graviton_threshold_sheet import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_closed_angular_cut",
    "whole_invariant_sheet_threshold_and_pole_running",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_invariant_sheet_threshold_and_pole_running"]
    else:
