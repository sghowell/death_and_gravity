...
import pytest
from p8_vacuum_affine_massive_common_gravity_masters import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_scalar_masters",
    "whole_common_cut_basis_and_external_legs",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_common_cut_basis_and_external_legs"]
    else:
