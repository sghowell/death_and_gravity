...
import pytest
from p8_vacuum_affine_radiative_state_soft_index import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_radiative_recoil",
    "whole_massless_soft_index_and_uniform_stability",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_massless_soft_index_and_uniform_stability"]
    else:
