...
import pytest
from p8_vacuum_affine_complete_matter_graviton_endpoint import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_complete_matter_endpoint",
    "whole_physical_cuts_and_bounded_crossed_endpoint_coefficient",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_physical_cuts_and_bounded_crossed_endpoint_coefficient"]
    else:
