...
import pytest
from p8_vacuum_fermion_vertex_chord import verify
...
KEYS = [
    ...
    "proof_checks",
    "proper_MS_vertex_and_region_domains",
    "primitive_word_ownership",
    "soft_tail_and_radial_bound",
    "actual_completed_quartic_primitive_frontier",
    "controls",
    "verdict",
    "not_established",
...
def test_exact_counts_and_scope():
    ...
    assert "NOT_FULL_MATCHED_TWO_LOOP" in d["status"]
