...
import pytest
from p8_vacuum_affine_unequal_mass_regge_residue import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_unequal_mass_spin2",
    "whole_positive_spectral_moment_and_conditional_Regge_budget",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_positive_spectral_moment_and_conditional_Regge_budget"]
    else:
