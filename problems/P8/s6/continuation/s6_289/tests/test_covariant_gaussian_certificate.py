...
import pytest
from p8_vacuum_affine_covariant_gaussian_four_point_matching import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_covariant_local_map",
    "whole_Gaussian_four_point_and_forward_coefficients",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_Gaussian_four_point_and_forward_coefficients"]
    else:
