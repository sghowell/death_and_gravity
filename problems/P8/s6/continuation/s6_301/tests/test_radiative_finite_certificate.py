...
import pytest
from p8_vacuum_affine_radiative_angular_finite import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_dimensional_current",
    "whole_collinear_majorants_and_finite_conversion",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_collinear_majorants_and_finite_conversion"]
    else:
