...
import pytest
from p8_vacuum_affine_minimal_gravity_finite import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_finite_master_dictionary",
    "whole_finite_gravity_assembly_and_compact_bound",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_finite_gravity_assembly_and_compact_bound"]
    else:
