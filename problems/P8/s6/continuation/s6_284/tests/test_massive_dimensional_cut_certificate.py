...
import pytest
from p8_vacuum_affine_massive_dimensional_cut_completion import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_threshold_jets",
    "whole_dimensional_polarizations_and_finite_rational_terms",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_dimensional_polarizations_and_finite_rational_terms"]
    else:
