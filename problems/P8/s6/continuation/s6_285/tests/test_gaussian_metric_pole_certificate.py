...
import pytest
from p8_vacuum_affine_gaussian_metric_pole_matching import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_Gaussian_metric_cuts",
    "whole_fixed_Gaussian_polynomial_and_metric_poles",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_fixed_Gaussian_polynomial_and_metric_poles"]
    else:
