...
import pytest
from p8_vacuum_affine_massive_scalar_graviton_bremsstrahlung import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_complete_bremsstrahlung",
    "whole_physical_recoil_and_real_rate_error",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_physical_recoil_and_real_rate_error"]
    else:
