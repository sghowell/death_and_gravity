...
import pytest
from p8_vacuum_affine_mixed_gravity_physical_rate import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_physical_masters",
    "whole_finite_assembly_and_uniform_rate",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_finite_assembly_and_uniform_rate"]
    else:
