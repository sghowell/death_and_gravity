...
import pytest
from p8_vacuum_affine_complete_two_graviton_tree import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_rooted_trees",
    "whole_action_and_soft_calibrations",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_action_and_soft_calibrations"]
    else:
