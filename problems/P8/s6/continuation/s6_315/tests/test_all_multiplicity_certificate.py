...
import pytest
from p8_vacuum_affine_all_multiplicity_tree_source import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_all_order_vertices",
    "whole_all_N_topology_and_finite_tree_source",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_all_N_topology_and_finite_tree_source"]
    else:
