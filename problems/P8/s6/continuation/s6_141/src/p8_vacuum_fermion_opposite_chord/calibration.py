"""Actual separate scalar/gauge opposite-chord coefficient enclosures."""
...
def data():
    ...
    E = result["combined_opposite_chord_b2_absolute_upper"]
    tree = 4 * p["lambda"]
    relative = E / tree
    return {
        ...
        "actual_opposite_chord_enclosure": result,
        "combined_opposite_chord_upper_relative_to_tree": relative,
        "checks": {
            ...
            - result["gauge_opposite_chord_b2_absolute_upper"],
            "relative_tree_dictionary": relative * tree - E,
            "actual_Cauchy_radius_minimum": result["minimum_joint_Cauchy_radius"]
            - m / 360,
            "remaining_vertex_words_only": 2
            * result["remaining_vertex_words_per_sector"]
            - 48,
        },
        "bounds": {
            ...
            "actual_scalar_subset_bound_strictly_positive": bool(
                result["scalar_opposite_chord_b2_absolute_upper"] > 0
            ),
            "actual_gauge_subset_bound_strictly_positive": bool(
                result["gauge_opposite_chord_b2_absolute_upper"] > 0
            ),
