...
import pytest
from p8_vacuum_affine_physical_virtual_soft_pairing import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_dimensional_soft_conversion",
    "whole_dimensional_continuity_and_inclusive_reference",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_dimensional_continuity_and_inclusive_reference"]
    else:
