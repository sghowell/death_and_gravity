...
import pytest
from p8_vacuum_affine_massive_gravity_pole_completion import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_physical_pole_jets",
    "whole_graph_completion_and_retained_Coulomb_kernel",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_graph_completion_and_retained_Coulomb_kernel"]
    else:
