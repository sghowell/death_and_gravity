...
import pytest
from p8_vacuum_affine_minimal_gravity_radiation import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_canonical_vertices",
    "whole_general_Ward_identity_and_real_rate",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_general_Ward_identity_and_real_rate"]
    else:
