...
import pytest
from p8_vacuum_affine_whole_quartic_gravity_sector import verify
...
KEYS = [
    ...
    "proof_checks",
    "whole_original_source_and_complete_quartic_graphs",
    "whole_scalar_cut_and_finite_forward_coefficient",
...
def test_missing_and_extra_fields_rejected(mutation):
    ...
    bad = copy.deepcopy(data)
    if mutation == "missing":
        del bad["whole_scalar_cut_and_finite_forward_coefficient"]
    else:
