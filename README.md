...
- P8 S6: [conditional UV framework and vacuum-extension test](problems/P8/s6/README.md).
  ...
  The [causal actual-source theorem](problems/P8/s6/matching/variable/response/forced/README.md)
  ...
  tends to zero. A [conditional reciprocal-scale theorem](problems/P8/s6/matching/variable/global/reciprocal/README.md)
  proves finite second-metric null tails under explicit geometric and
...
The [radiative-state soft index](docs/assessment-2026-09-15-p8-affine-radiative-state-soft-index.md)
now includes all massive/null and null/null pairs for arbitrary finite
radiation multiplicity. Its uniform stability bound requires real and
virtual poles to use the same state. Native replay, 401 original-SymPy
...
The [single-residual soft-dressing assessment](docs/assessment-2026-09-16-p8-affine-single-residual-soft-dressing.md)
controls the state-correct leading-soft dressing of one complete signed
47-tree radiative residual, with the remaining-energy cut and a relative
bound below 2e-768 that vanishes with detector resolution. Native, 602
...
The [gauge-complete temporal tree reorganization assessment](docs/assessment-2026-09-16-p8-affine-temporal-tree-reorganization.md)
derives the gauge-complete temporal reorganization at every finite tree
order and a uniform three-ray bound for the specified planar family.
Native, 744 original-SymPy ordinary tests and independent CLI replay
passed in the documented sequential acceptance batch; the 88,848-test
regression passed. This remains a finite-tree result: original V/G/B/P8
closure is open.

The [uniform weighted currents at every finite multiplicity assessment](docs/assessment-2026-09-16-p8-affine-uniform-soft-current-bound.md)
proves the weighted temporal soft-current bound at every finite
multiplicity, uniformly in positive energy hierarchies and angles.
Native, 603 original-SymPy ordinary tests and independent CLI replay
passed in the documented sequential acceptance batch; the 88,848-test
regression passed. This remains a finite-tree result: original V/G/B/P8
closure is open.
...
original common-parent bounce and P8 remain open.
The [four-point loop and symmetric matching audit](docs/assessment-2026-09-12-p8-affine-heavy-scalar-four-point-loop.md)
...
full quantum matching or the original common-parent bounce. P8 remains open.
The [scalar transfer and spectral-moment audit](docs/assessment-2026-09-12-p8-affine-scalar-transfer-moment.md)
