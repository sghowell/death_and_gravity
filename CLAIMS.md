...
| P9-1 | P9 | For the class C(G, L=1.5) and frozen inputs, a class member with χ² ≤ χ²_min + 4 has H₀ = 69.53 (r_lo), i.e. max H₀ ≥ 69.53; L = 1: 69.75; L = 3: 69.74 | CONJECTURED (float-verified feasible point) | problems/P9/src/p9/feasible.py; session log | 2026-08-25 |
